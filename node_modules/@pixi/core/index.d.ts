...
import type { Buffer as Buffer_3 } from '@pixi/core';
...
import type { IRenderingContext as IRenderingContext_2 } from '@pixi/core';
import type { ISize } from '@pixi/math';
import type { ISpriteMaskFilter as ISpriteMaskFilter_2 } from '@pixi/core';
import type { ISystem as ISystem_2 } from '@pixi/core';
...
import type { Renderer as Renderer_2 } from '@pixi/core';
import type { RENDERER_TYPE } from '@pixi/constants';
import { Runner } from '@pixi/runner';
import { SCALE_MODES } from '@pixi/constants';
import type { Shader as Shader_2 } from '@pixi/core';
import { TARGETS } from '@pixi/constants';
import type { Transform } from '@pixi/math';
 ...
 */
export declare function autoDetectRenderer(options?: IRendererOptionsAuto): IRenderer;
...
export declare interface IImageBitmapResourceOptions {
...
export declare interface IProgramExtraData {
 ...
 * @memberof PIXI
 */
export declare interface IRenderableObject extends GlobalMixins.IRenderableObject {
 ...
 * @memberof PIXI
 */
export declare interface IRenderer extends SystemManager, GlobalMixins.IRenderer {
    resize(width: number, height: number): void;
...
export declare interface IRendererConstructor {
...
export declare interface IRendererPlugins extends GlobalMixins.IRendererPlugins {
    [key: string]: any;
}
 ...
 * @memberof PIXI
 */
export declare interface ISystem<INIT_OPTIONS = null, DESTROY_OPTIONS = null> {
    init?(options?: INIT_OPTIONS): void;
    /** Generic destroy methods to be overridden by the subclass */
    destroy?(options?: DESTROY_OPTIONS): void;
}

declare interface ISystemConfig<R> {
    runners: string[];
...
export declare interface Renderer extends GlobalMixins.Renderer {
}
...
export declare interface StartupOptions extends Record<string, unknown> {
    hello: boolean;
...
export declare class TransformFeedback {
     ...
     */
    bindBuffer(index: number, buffer: Buffer_3): void;
 ...
 * @memberof PIXI
 */
export declare class TransformFeedbackSystem implements ISystem_2 {
    /** @ignore */
    static extension: ExtensionMetadata;
    CONTEXT_UID: number;
    gl: IRenderingContext_2;
    private renderer;
    /**
     * @param renderer - The renderer this System works for.
     */
     ...
     */
    beginTransformFeedback(drawMode: DRAW_MODES, shader?: Shader_2): void;
