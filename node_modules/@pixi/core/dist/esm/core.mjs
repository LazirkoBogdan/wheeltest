...
import { ENV, ALPHA_MODES, SCALE_MODES, FORMATS, TYPES, TARGETS, MSAA_QUALITY, MIPMAP_MODES, BUFFER_TYPE, CLEAR_MODES, DRAW_MODES, BUFFER_BITS, MASK_TYPES, PRECISION, BLEND_MODES, GC_MODES, SAMPLER_TYPES, WRAP_MODES } from '@pixi/constants';
export * from '@pixi/constants';
import { ExtensionType, extensions as extensions$1 } from '@pixi/extensions';
export * from '@pixi/extensions';
import { groupD8, Rectangle, Point, Matrix, Transform } from '@pixi/math';
export * from '@pixi/math';
import { Runner } from '@pixi/runner';
export * from '@pixi/runner';
import { Ticker } from '@pixi/ticker';
export * from '@pixi/ticker';
import { EventEmitter, uid, isPow2, BaseTextureCache, TextureCache, determineCrossOrigin, getResolutionOfUrl, nextPow2, getBufferType, ProgramCache, removeItems, string2hex, hex2string, hex2rgb, deprecation, isWebGLSupported, premultiplyBlendMode, log2, premultiplyTint } from '@pixi/utils';
...
const _BaseTexture = class extends EventEmitter {
  constructor(resource = null, options = null) {
    ...
    this._mipmap = mipmap ?? settings$1.MIPMAP_TEXTURES;
    this.anisotropicLevel = anisotropicLevel ?? settings$1.ANISOTROPIC_LEVEL;
    this._wrapMode = wrapMode || settings$1.WRAP_MODE;
    this._scaleMode = scaleMode ?? settings$1.SCALE_MODE;
...
class ImageResource extends BaseImageResource {
  constructor(source, options) {
    ...
    this.createBitmap = (options.createBitmap ?? settings$1.CREATE_IMAGE_BITMAP) && !!globalThis.createImageBitmap;
...
class ImageBitmapResource extends BaseImageResource {
  ...
  static get EMPTY() {
    ImageBitmapResource._EMPTY = ImageBitmapResource._EMPTY ?? settings$1.ADAPTER.createCanvas(0, 0);
...
class Filter extends Shader {
  constructor(vertexSrc, fragmentSrc, uniforms) {
    ...
    this.padding = 0;
    this.resolution = settings$1.FILTER_RESOLUTION;
    this.multisample = settings$1.FILTER_MULTISAMPLE;
    this.enabled = true;
    this.autoFit = true;
...
const _BatchRenderer = class extends ObjectRenderer {
  constructor(renderer) {
    ...
    this.size = settings$1.SPRITE_BATCH_SIZE * 4;
    this._vertexCount = 0;
    this._indexCount = 0;
