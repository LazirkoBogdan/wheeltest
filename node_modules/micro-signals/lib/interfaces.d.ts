export declare type Listener<T> = (payload: T) => void;
...
export declare type Accumulator<T, U> = (accum: U, current: T) => any;
export declare type PayloadOf<S extends BaseSignal<any>> = S extends BaseSignal<infer T> ? T : never;
export declare type ReadOnlyVersionOf<S extends BaseSignal<any>> = S extends BaseSignal<infer T> ? ReadableSignal<T> : never;
